...
<section class="Why-We" id='Why-We'>
    ...
    <div class="container-main">
        ...
        <div class="contant-right contant">
            <h2><i class="fas fa-check-circle"></i>Continuous improvement of work processes to achieve maximum customer
                satisfaction</h2>
...
<section class="client">
    ...
    <div class="client-wrap">
        ...
        <div class="content">
            <span></span>
            <p>We are a client-centric organization that is focused towards meeting the clients’ requirements and
                demands in the best possible manner. In order to match up to the expectations of our clients, we
                manufacture our products using optimum quality materials. Further, we check the products on quality,
                right from the procurement of raw material to the final dispatch of products. We not only adhere to the
                international quality standards during manufacturing process, but also cater to the specific needs of
                our clients, located across the globe.</p>
        </div>
    </div>
</section>
